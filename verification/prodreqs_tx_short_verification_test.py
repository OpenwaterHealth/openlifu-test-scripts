...
class TransmitterShortVerificationTest(TestSonicationDurationBase):
    ...
    def print_banner(self) -> None:
        ...
        self.logger.info("--------------------------------------------------------------------------------")
        self.logger.info(
            "\n\nThis script will run the following test case to confirm communication and general functionality:\n\n" + 
    ...
    def run(self) -> None:
        ...
        self.logger.info(f"Starting run of test case {self.test_case}. ")
